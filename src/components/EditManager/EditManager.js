...
function EditManager({ userInfo }) {
  ...
  const handleUpdate = async (e) => {
    ...
    const url = `${API_PATH}/manager/update/${userInfo.manager_id}`;

    let form = new FormData();
    form.append("manager_name", name);
    ...
    if (res.ok) {
      ...
      setErr(`فشل في تعديل بيانات ${userInfo.manager_name}`);
    }
  };
